...
#SBATCH --qos normal 
#SBATCH -p p100
#SBATCH -o slurm-%A_%a-_hmm_mnar_rnn.out
#SBATCH --error slurm-%A_%a_hmm_mnar_rnn.out
  ...
  do
    ...
    then
      ...
      do
        ...
        python3 -u run_models.py --niters 500 -n 250 -s 50 -l 10 --dataset markov_chain  --classic-rnn --noise-weight 0.01 \
