...
#SBATCH --qos normal 
#SBATCH -p p100
#SBATCH -o slurm-%A_%a_sin_mcar_odernn.out
#SBATCH --error slurm-%A_%a__sin_mcar_odernn.out
  ...
  do
    ...
    then
      ...
      do
        ...
        python3 -u run_models.py --niters 500 -n 250 -s 50 -l 10 --dataset periodic  --ode-rnn --noise-weight 0.01 \
