...
#SBATCH --qos normal 
#SBATCH -p p100
#SBATCH -o slurm-%A_%a-_hmm_mnar_rnnvae.out
#SBATCH --error slurm-%A_%a_hmm_mnar_rnnvae.out
  ...
  do
    ...
    then
      ...
      do
        ...
        python3 -u run_models.py --niters 500 -n 250 -s 50 -l 10 --dataset markov_chain  --rnn-vae --noise-weight 0.01 \
